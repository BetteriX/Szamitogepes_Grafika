...
char			windowTitle[] = "Parametric surface";
...
glm::mat4		model, view, projection = glm::perspective(glm::radians(45.0f), (float)windowWidth / (float)windowHeight, 0.1f, 100.0f);
...
void display() {
	...
	float cameraSpeed = 5.0f * (GLfloat)deltaTime;
