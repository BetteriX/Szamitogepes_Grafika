...
void display(GLFWwindow* window, double currentTime) {
	...
	/** Draw the brick. */
	glDrawArrays(GL_TRIANGLES, 0, sizeof(verticesData) / (6 * sizeof(GLfloat))); // 6 component, sizeof(GLfloat) = 4 bytes
}
...
int main(void) {
	...
	cout << "Lighting and Z-buffer" << endl;
	cout << "https://learnopengl.com/Lighting/Basic-Lighting" << endl << endl;
	...
	cout << "Gyakorlat 1: Adjunk a shader kódhoz globalAmbientColor-t!" << endl;
	cout << "Gyakorlat 2: Adjuk át uniform tömbbel a fényforrás szín komponenseit a shadernek!" << endl;
	cout << "Gyakorlat 3: Tegyük kezelhetővé az OpenGL szabvány legalább 8 független fényforrását!" << endl;
	cout << "Activity  1: Add globalAmbientColor to the shader code!" << endl;
	cout << "Activity  2: Pass the color components as uniform array to the shader code!" << endl;
	cout << "Activity  3: Make work at least 8 independent light sources according to the OpenGL standard!" << endl;
