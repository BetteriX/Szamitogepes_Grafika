// Gyakorlat 1: Fedezzük fel a különböző primitívek rajzolását! https://www.khronos.org/opengl/wiki/primitive
// Activity 1:  Experience the different primitive types at drawing! https://www.khronos.org/opengl/wiki/primitive
#include <fstream>
#include <GL/glew.h>
...
void display(GLFWwindow* window, double currentTime) {
	...
	glVertex2f( 0.25, -0.25);				// given by 2D Euclidean space Cartesian coordinates
...
void keyCallback(GLFWwindow* window, int key, int scancode, int action, int mods) {
	...
	if ((action == GLFW_PRESS) && (key == GLFW_KEY_S)) pipeline = ShaderProgram, glUseProgram(renderingProgram);
}
...
int main(void) {
	...
	if ((window = glfwCreateWindow(window_width, window_height, window_title, nullptr, nullptr)) == nullptr) {
	...
	cout << "Keyboard control" << endl << endl;
	cout << "ESC\texit" << endl;
	...
	cout << "S\tshader program (visual feedback CMYK and vec4(0.2, 0.2, 0.0, 0.0) offset)" << endl;
